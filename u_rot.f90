...
!                          Thir program is for "U" based on that for "S"
!                          After some tests with IDA and discussion with Zdeneck Martinek 
! March 16 2012: Implementation of the numerical derivative "in the future"
!
! +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
...
!
! ====== Modified March 16 2012 GS: N+1
!
 COMPLEX*16 LOT  (JMAX,0:NN+1), DLOAD(JMAX,0:NN+1), DINER_R(0:NN+1)
 COMPLEX*16 UROT (JMAX,0:NN+1)
!
!
...
! ///////////////////////////////////////////////////////
!
 open (1,file=FILE_UROT,status='unknown',form='formatted') 
!
     UROT (:,:)  = (0D0,0D0)
!
     J21=J_INDEX(2,1)
...
!     
          DO 16 K=0, I 
!     
     	     UROT (J21,I)  = UROT (J21,I)  + DCONJG(DINER_R(K)) * SFUNC(DELTA*DFLOAT(I-K))
! 
 16       CONTINUE
!     
        UROT (J21,I) =  UROT (J21,I) * (SIGMA_21/GRA_REF)*(ERAD**4/(CCCC-AAAA))
!     
 15   CONTINUE 
!
      write(1,*)UROT
