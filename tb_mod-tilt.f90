...
!
 ...
 open(9,file='ebt.dat',status='unknown')
!  
 do l=0, lmax
 	 ...
 	 write(7,*) l, EFA(l), (betafa(l,k), k=0, nn)
 	 write(8,*) l, ESS(l), (betass(l,k), k=0, nn)
 	 write(9,*) l, ET(l), (betat(l,k), k=0, nn)
 enddo
!
 close(1)
 close(2)
...
!
!
    ggg =6.6732q-11    ! Newton constant
!
!
!
!
