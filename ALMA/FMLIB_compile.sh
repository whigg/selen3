...
#
echo FMSAVE
g95 FMSAVE.f90  -c  -ffree-form   -o FMSAVE.o
#
echo FMZM90
g95 FMZM90.f90  -c  -ffree-form   -o FMZM90.o
echo FM
g95 FM.f90  -O  -c  -ffree-form    -o FM.o
echo TestFM
g95 TestFM.f90  -c   -ffree-form   -o TestFM.o
g95 TestFM.o    FMSAVE.o    FMZM90.o     FM.o   -o TestFM
echo SampleFM
g95 SampleFM.f90  -c  -ffree-form    -o  SampleFM.o
