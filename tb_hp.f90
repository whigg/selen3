...
!
	...
	EV(l) =      l_e(l) 
      	ES(l) = EN(l)-EU(l)  
!
      	EFA(l) = float(l+2)            - float(l-1)*k_e(l)  	  
...
!
 ...
 type(fm), external :: ded			      ! Useful to compute the determinant
!
...
integer (i4b) ::  j, k 
!
type(fm) :: massa_in (nv+1)
type(fm) :: ra0, rhor, rig, t0 
type(fm), parameter :: haskell = 1.q21   ! HASKELL unit 
!
!
!
...
r (4)      = 6371._qp; rho(4)=3037._qp ; rmu(4)=0.50605_qp     ! Lithosphere  
!
endif 
!
!
