...
! *** Reviewed DM November 2011 - Dynamic memory allocation, QuickSort
! *** Reviewed DM November 2011 - Optimized anchor point assignment
!
! +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
...
! 	  	  - "px-lat.dat"
!		  - "pxa.dat" 	
!                 - "anchor.tmp"    NEW   number of anchor pixels for use in other codes
!                                                                          
!
MODULE COMMON
IMPLICIT NONE 
...
!
  ...
  REAL*8, PARAMETER :: EPS = 1.0d-8           ! Tolerance in anchor latitude identification
!
!
!
!
...
!
    ...
    write(*, *) '    - The pixels spacing is:', 4.0*6371.0/sqrt(float(n)), ' km'
!
